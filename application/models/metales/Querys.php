    ...
    function metalesCreate()
    {
        ...
        */
        ...
        $data = array(
            ...
            'detail_id_advance' => $_POST['detail_id_advance'],
            'detail_fecha'      => $_POST['detail_fecha'],
            'detail_status'     => $_POST['detail_status'],
            'detail_tipo'       => $_POST['detail_tipo'],
            'detail_metal'      => $_POST['detail_metal'],
            'detail_grs'        => $_POST['detail_grs'],
            'detail_precio'     => $_POST['detail_precio'],
            'detail_saldo'      => $_POST['detail_saldo']
        );
